# flashcube.console.mixins
# Mixins for the command line program as well as other helpers.
#
# Author:   Benjamin Bengfort <benjamin@bengfort.com>
# Created:  Fri Oct 16 21:01:36 2015 -0400
#
        ...
        if os.path.isfile(path):
            ...
            if not force:
                if not super(OverwriteConfirmationMixin, self).confirm("Overwrite the file and permenantly destroy its contents?"):
                    raise ConsoleError("Unable to write to file at %s" % path)
            os.remove(path)
        return True
